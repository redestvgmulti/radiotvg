...
const mockVideos = [
  { id: '1', title: 'Culto ao Vivo — Domingo', thumbnail: thumbLiveCulto, isLive: true, views: '2.3K', duration: '' },
  { id: '2', title: 'Manhã Sertaneja', thumbnail: thumbManhaSertaneja, isLive: false, views: '890', duration: '1:32:00' },
  { id: '3', title: 'Entrevista Especial', thumbnail: thumbEntrevista, isLive: false, views: '1.1K', duration: '45:20' },
  { id: '4', title: 'Show Raiz — Gravado', thumbnail: thumbShowRaiz, isLive: false, views: '560', duration: '2:10:00' },
  { id: '5', title: 'Top Hits da Semana', thumbnail: thumbTopHits, isLive: false, views: '3.4K', duration: '58:00' },
  { id: '6', title: 'Gospel Night Session', thumbnail: thumbGospelNight, isLive: false, views: '2.1K', duration: '1:45:00' },
];
    ...
    >
      ...
      {liveVideos.map((video) => (
        <motion.div
          ...
          style={{ height: '45vh', minHeight: 260, maxHeight: 420 }}
        >
          <img
            src={video.thumbnail}
            alt={video.title}
      ...
      <div className="px-4">
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide pb-3 mb-4">
          {otherVideos.slice(0, 3).map((video, i) => (
            <motion.div
              ...
              whileTap={{ scale: 0.97 }}
              className="relative flex-shrink-0 w-[220px] h-[130px] rounded-2xl overflow-hidden cursor-pointer group"
            >
              <img
                src={video.thumbnail}
                alt={video.title}
        ...
        <div className="flex flex-col gap-3">
          {otherVideos.slice(3).map((video, i) => (
            ...
            >
              <div className="relative flex-shrink-0 w-[140px] h-[80px] rounded-xl overflow-hidden">
                <img
                  src={video.thumbnail}
                  alt={video.title}
                  className="absolute inset-0 w-full h-full object-cover transition-transform duration-300 group-hover:scale-105"
