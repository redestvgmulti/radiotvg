...
const listenersWeek = [
  { day: 'Seg', ouvintes: 1240 },
  { day: 'Ter', ouvintes: 1580 },
  { day: 'Qua', ouvintes: 1320 },
  { day: 'Qui', ouvintes: 1890 },
  { day: 'Sex', ouvintes: 2100 },
  { day: 'Sáb', ouvintes: 2450 },
  { day: 'Dom', ouvintes: 2780 },
];

const accessByHour = [
  { hora: '6h', acessos: 320 },
  { hora: '8h', acessos: 580 },
  { hora: '10h', acessos: 720 },
  { hora: '12h', acessos: 890 },
  { hora: '14h', acessos: 650 },
  { hora: '16h', acessos: 780 },
  { hora: '18h', acessos: 920 },
  { hora: '20h', acessos: 1100 },
  { hora: '22h', acessos: 850 },
  { hora: '00h', acessos: 420 },
];

const envDistribution = [
  { name: 'Sertanejo', value: 42, color: 'hsl(35, 90%, 55%)' },
  { name: 'Pop/Rock', value: 28, color: 'hsl(280, 70%, 55%)' },
  { name: 'Gospel', value: 18, color: 'hsl(200, 80%, 55%)' },
  { name: 'Raiz', value: 12, color: 'hsl(140, 60%, 45%)' },
];
        ...
        >
          ...
          <div className="flex items-center gap-4">
            <div className="h-[120px] w-[120px] flex-shrink-0">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={envDistribution} cx="50%" cy="50%" innerRadius={30} outerRadius={55} dataKey="value" strokeWidth={0}>
                    {envDistribution.map((entry) => (
